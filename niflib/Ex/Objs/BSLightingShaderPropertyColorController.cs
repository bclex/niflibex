 ...
 */
public static NiObject Create() => new BSLightingShaderPropertyColorController();

/*! NIFLIB_HIDDEN function.  For internal use only. */
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {

	base.Read(s, link_stack, info);
	Nif.NifStream(out typeOfControlledColor, s, info);
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(typeOfControlledColor, s, info);
...
public override string AsString(bool verbose = false) {
	...
	s.AppendLine($"  Type of Controlled Color:  {typeOfControlledColor}");
	return s.ToString();
...
//--BEGIN:FILE FOOT--//
        /*!
         * Gets or sets which color in BSLightingShaderProperty to animate
         */
        public LightingShaderControlledColor TypeOfControlledColor
        {
