 ...
 */
public static NiObject Create() => new NiPSBoxEmitter();

/*! NIFLIB_HIDDEN function.  For internal use only. */
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {

	base.Read(s, link_stack, info);
	Nif.NifStream(out emitterWidth, s, info);
	Nif.NifStream(out emitterHeight, s, info);
	Nif.NifStream(out emitterDepth, s, info);
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(emitterWidth, s, info);
	Nif.NifStream(emitterHeight, s, info);
	Nif.NifStream(emitterDepth, s, info);
