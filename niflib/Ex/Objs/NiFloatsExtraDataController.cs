 ...
 *             '%s[%d]'
 *         Where %s = Value of "Extra Data Name", %d = Value of "Floats Extra Data
 * Index"
 */
public class NiFloatsExtraDataController : NiExtraDataController {
	//Definition of TYPE constant
	public static readonly Type_ TYPE = new Type_("NiFloatsExtraDataController", NiExtraDataController.TYPE);
	/*!  */
 ...
 */
public static NiObject Create() => new NiFloatsExtraDataController();
...
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {
	...
	Nif.NifStream(out floatsExtraDataIndex, s, info);
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(floatsExtraDataIndex, s, info);
	if (info.version <= 0x0A010067) {
...
public override string asString(bool verbose = false) {
	...
	s.AppendLine($"  Floats Extra Data Index:  {floatsExtraDataIndex}");
