 ...
 */
public static NiObject Create() => new bhkBlendCollisionObject();
...
public override string asString(bool verbose = false) {
	...
	s.AppendLine($"  Heir Gain:  {heirGain}");
	s.AppendLine($"  Vel Gain:  {velGain}");
	s.AppendLine($"  Unk Float 1:  {unkFloat1}");
	s.AppendLine($"  Unk Float 2:  {unkFloat2}");
	return s.ToString();
