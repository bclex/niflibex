 ...
 */
public static NiObject Create() => new BSLagBoneController();
...
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {
	...
	Nif.NifStream(out linearRotation, s, info);
	Nif.NifStream(out maximumDistance, s, info);
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(linearRotation, s, info);
	Nif.NifStream(maximumDistance, s, info);
