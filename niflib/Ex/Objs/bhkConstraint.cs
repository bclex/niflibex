...
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {
	...
	for (var i1 = 0; i1 < entities.Length; i1++) {
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	numEntities = (uint)entities.Length;
...
//--BEGIN:FILE FOOT--//
         ...
         */
        public void AddEntity(bhkEntity obj) => entities.Add(obj);

        /*!
         * Removes an entity from this bhkConstraint.
         */
        public void RemoveEntity(bhkEntity obj)
        {
         ...
         */
        public IList<bhkEntity> Entities { get => entities; }
//--END:CUSTOM--//
