...
public class bhkConvexTransformShape : bhkTransformShape {
	...
	public static readonly Type_ TYPE = new Type_("bhkConvexTransformShape", bhkTransformShape.TYPE);

	public bhkConvexTransformShape() {
	}
	 ...
	 */
	public static NiObject Create() => new bhkConvexTransformShape();
