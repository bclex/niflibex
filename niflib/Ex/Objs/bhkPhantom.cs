 ...
 */
public class bhkPhantom : bhkWorldObject {
	//Definition of TYPE constant
	public static readonly Type_ TYPE = new Type_("bhkPhantom", bhkWorldObject.TYPE);
	 ...
	 */
	public static NiObject Create() => new bhkPhantom();
