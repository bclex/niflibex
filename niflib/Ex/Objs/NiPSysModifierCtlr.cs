...
public class NiPSysModifierCtlr : NiSingleInterpController {
	...
	public IndexString modifierName;
	 ...
	 */
	public static NiObject Create() => new NiPSysModifierCtlr();
	...
	internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
		...
		Nif.NifStream(modifierName, s, info);
	...
	public override string asString(bool verbose = false) {
		...
		s.AppendLine($"    Modifier Name:  {modifierName}");
		return s.ToString();
