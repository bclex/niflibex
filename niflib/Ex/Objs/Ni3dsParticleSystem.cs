...
public class Ni3dsParticleSystem : NiObject {
	...
	public static readonly Type_ TYPE = new Type_("Ni3dsParticleSystem", NiObject.TYPE);
	/*! Unknown. */
	 ...
	 */
	public static NiObject Create() => new Ni3dsParticleSystem();
	...
	public override string AsString(bool verbose = false) {
		...
		for (var i2 = 0; i2 < 14; i2++) {
			...
			s.AppendLine($"      Unknown 1[{i2}]:  {unknown1[i2]}");
			array_output_count++;
		}
		return s.ToString();
