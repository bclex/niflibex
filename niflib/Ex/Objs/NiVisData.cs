 ...
 */
public static NiObject Create() => new NiVisData();
...
//--BEGIN:FILE FOOT--//
/*! Gets or sets the visibility key data.
...
* object.
*/
public void NormalizeKeys(float phase, float frequency) => Key.NormalizeKeyVector(keys, phase, frequency);
//--END:CUSTOM--//
