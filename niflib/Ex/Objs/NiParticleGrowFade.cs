...
public class NiParticleGrowFade : NiParticleModifier {
	...
	public static readonly Type_ TYPE = new Type_("NiParticleGrowFade", NiParticleModifier.TYPE);
	/*!
 ...
 */
public static NiObject Create() => new NiParticleGrowFade();
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(grow, s, info);
	Nif.NifStream(fade, s, info);
...
public override string AsString(bool verbose = false) {
	...
	s.AppendLine($"  Grow:  {grow}");
	s.AppendLine($"  Fade:  {fade}");
	return s.ToString();
