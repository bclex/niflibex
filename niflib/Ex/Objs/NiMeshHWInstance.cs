 ...
 */
public static NiObject Create() => new NiMeshHWInstance();
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	WriteRef((NiObject)masterMesh, s, info, link_map, missing_link_stack);
	WriteRef((NiObject)meshModifier, s, info, link_map, missing_link_stack);
...
internal override List<NiObject> GetRefs() {
	...
	if (masterMesh != null)
		refs.Add((NiObject)masterMesh);
	if (meshModifier != null)
		refs.Add((NiObject)meshModifier);
	return refs;
}
