...
public class NiPSEmitParticlesCtlr : NiPSEmitterCtlr {
	...
	/*!  */
	public NiInterpolator emitterActiveInterpolator;
 ...
 */
public static NiObject Create() => new NiPSEmitParticlesCtlr();
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	WriteRef((NiObject)emitterActiveInterpolator, s, info, link_map, missing_link_stack);
...
public override string asString(bool verbose = false) {
	...
	s.AppendLine($"  Emitter Active Interpolator:  {emitterActiveInterpolator}");
	return s.ToString();
...
internal override List<NiObject> GetRefs() {
	...
	if (emitterActiveInterpolator != null)
		refs.Add((NiObject)emitterActiveInterpolator);
	return refs;
}
