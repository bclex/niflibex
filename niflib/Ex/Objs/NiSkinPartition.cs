...
namespace Niflib
{
    ...
    public class NiSkinPartition : NiObject
    {
        ...
        {
            get => skinPartitionBlocks.Count;
            set
            {
                var part = new SkinPartition();
                part.numVertices = 0;
                part.numTriangles = 0;
                part.numBones = 0;
                part.numStrips = 0;
                ...
                numSkinPartitionBlocks = (uint)value;
            }
        }
         ...
         */
        public ushort GetWeightsPerVertex(int partition) => skinPartitionBlocks[partition].numWeightsPerVertex;
         ...
         */
        public ushort GetNumVertices(int partition)
        {
        }
