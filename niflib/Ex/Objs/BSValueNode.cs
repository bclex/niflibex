...
public class BSValueNode : NiNode {
	...
	public BSValueNode() {
	value = (uint)0;
	valueNodeFlags = (BSValueNodeFlags)0;
}
 ...
 */
public static NiObject Create() => new BSValueNode();
...
internal override void Read(IStream s, List<uint> link_stack, NifInfo info) {
	...
	Nif.NifStream(out valueNodeFlags, s, info);
...
internal override void Write(OStream s, Dictionary<NiObject, uint> link_map, List<NiObject> missing_link_stack, NifInfo info) {
	...
	Nif.NifStream(valueNodeFlags, s, info);
...
public override string AsString(bool verbose = false) {
	...
	s.AppendLine($"  Value Node Flags:  {valueNodeFlags}");
	return s.ToString();
