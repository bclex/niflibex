...
namespace Niflib
{
    ...
    public class NiControllerManager : NiTimeController
    {
        ...
        //--BEGIN:FILE FOOT--//
        /*!
         *  Gets or sets whether or not the animation sequences are cumulative.
        ...
        /*!
         * Gets or sets the list of controller sequences that this controller manager references.
         * \param[in] value The new controller sequences.
         */
        public IList<NiControllerSequence> ControllerSequences
        {
            get => controllerSequences;
            set
            {
                ClearSequences();
                controllerSequences = value;
                foreach (var it in controllerSequences)
                    it.Parent = this;
            }
        }
         ...
         */
        public void AddSequence(NiControllerSequence obj)
        {
            if (!controllerSequences.Contains(obj))
            {
                controllerSequences.Add(obj);
                obj.Parent = this;
            }
        }
         ...
         */
        public void RemoveSequence(NiControllerSequence obj)
        {
            if (controllerSequences.Contains(obj))
            {
                obj.Parent = null;
                controllerSequences.Remove(obj);
            }
        }
        ...
        /*!
         * Gets or sets the object pallete object used by this controller manager.
         * \param[in] value The new object pallete.
         */
        public NiDefaultAVObjectPalette ObjectPalette
        {
            get => objectPalette;
            set => objectPalette = value;
        }
        //--END:CUSTOM--//
