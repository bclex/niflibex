...
namespace Niflib
{
    ...
    public class NiPosData : NiObject
    {
        ...
        //--BEGIN:FILE FOOT--//
        /*! Gets or sets the type of position interpolation being used.  Does not affect existing key data.
