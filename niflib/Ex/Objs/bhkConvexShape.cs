...
namespace Niflib
{
    ...
    public class bhkConvexShape : bhkSphereRepShape
    {
        ...
        public static readonly Type_ TYPE = new Type_("bhkConvexShape", bhkSphereRepShape.TYPE);

        public bhkConvexShape()
        {
        }
         ...
         */
        public static NiObject Create() => new bhkConvexShape();
