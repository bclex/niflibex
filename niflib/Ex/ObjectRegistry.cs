...
namespace Niflib
{
    ...
    */
    public class ObjectRegistry
    {
         ...
         */
        static void RegisterObject(string type_name, Func<NiObject> create_func) => object_map[type_name] = create_func;

        /*! 
         * NIFLIB_HIDDEN function.  For internal use only.
         * Called during file reads to create objects of a named type.
         */
        static NiObject CreateObject(string type_name) => object_map.TryGetValue(type_name, out var func) ? func() : null;
    }
}
